      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            {/* Output Section - 用户友好展示 */}
            <div className="design-card">
              <div className="flex items-center gap-4 mb-8">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-r from-purple-500 to-purple-600 flex items-center justify-center text-white text-2xl">
                  <RiFileTextLine />
                </div>
                <div>
                ...
                <div className="bg-gradient-to-br from-white/5 to-white/10 rounded-xl p-6">
                  ...
                  <div className="bg-gray-900/50 rounded-lg p-4 font-mono text-sm mb-4 border-l-2 border-purple-500">
                    <div className="space-y-2 text-gray-300">
                      <div>[00:00:05] Hello everyone, welcome to today's product demo.</div>
                      <div>[00:00:12] We'll be showcasing our advanced video transcription technology.</div>
                      <div>[00:00:25] First, let me show you how accurate our AI model is.</div>
                      <div>[00:00:38] As you can see, we capture every word with remarkable precision.</div>
                      <div>[00:00:52] The system also handles technical terms and proper nouns correctly.</div>
